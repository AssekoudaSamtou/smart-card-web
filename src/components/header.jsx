...
const Header = () => (
	<header sx={{bg: '#FFF', position: 'fixed', width: 'calc(100vw - 250px)', borderColor: 'primary', display: 'flex', alignItems: 'center',  justifyContent: 'space-between', padding: '30px', borderBottom: '1px solid #EDF2F7', zIndex: '1'}}>
